...
public class Jenisbarang extends javax.swing.JFrame {
    ...
    private void tabel() {
      String[] judul = {"ID","Nama Jenis","Kode Jenis","Keterangan"};
      model = new DefaultTableModel(judul,0);
      jTable1.setModel(model);
      String sql = "select * from jenis where nama_jenis like '%"+jTextField3.getText()+"%' or kode_jenis like '%"+jTextField3.getText()+"%'";
      ...
      try {
         ...
         while(rs.next()) {
             ...
             String[] data = {id,namajenis,kodejenis,keterangan};
             model.addRow(data);
         }
      }catch (Exception e) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String namajenis = jTextField1.getText();
        String kodejenis = jTextField2.getText();
        ...
        if (jTextField1.getText().equals("")|| jTextField2.getText().equals("")|| jTextArea1.getText().equals("")) {
            ...
            try {
                con.simpanData("insert into jenis value(null,'"+namajenis+"','"+kodejenis+"','"+keterangan+"')");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        try {
            con.simpanData("delete from jenis where id_jenis ='"+model.getValueAt(jTable1.getSelectedRow(),0)+"'");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        try {
            con.simpanData("update jenis set nama_jenis='"+nama+"', kode_jenis='"+kode+"',keterangan='"+keterangan+"' where id_jenis='"+model.getValueAt(jTable1.getSelectedRow(),0)+"'");
